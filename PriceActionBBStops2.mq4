...
void GenerateStopLoss()
{
double BBands1 = iBands(NULL,NULL,BBandsPeriod,StopLossSD,0,PRICE_CLOSE,MODE_LOWER,0);
double BBands2 = iBands(NULL,NULL,BBandsPeriod,StopLossSD,0,PRICE_CLOSE,MODE_MAIN,0);
stopLoss = (BBands2 - BBands1) / Point;
double StopLevel = MarketInfo(Symbol(),MODE_STOPLEVEL);

if (stopLoss <StopLevel){
stopLoss = StopLevel+5;
Print("Order s/l set at min : ",StopLevel, " not ",(BBands2 - BBands1) / Point) ;
} 
